...
// Brand logo URLs — using carlogos.org CDN + local files for niche brands
const CDN  = 'https://www.carlogos.org/car-logos/';
const LOCAL = 'img/brands/';
const BRAND_LOGOS = {
